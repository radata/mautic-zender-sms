...
namespace MauticPlugin\ZenderSmsBundle\EventListener;
...
class ButtonSubscriber implements EventSubscriberInterface
{
    ...
    {
        $myIntegration = $this->helper->getIntegrationObject('ZenderSms');
            ...
            $event->addButton(
                [
                    'attr' => [
                        ...
                        'data-header' => $this->translator->trans('zender_sms.send.header'),
                        'href'        => $this->router->generate(
                            'mautic_plugin_zendersms_action',
                            ['objectAction' => 'sendSms', 'objectId' => $contactId]
                        ),
                    ],
                    'btnText'   => $this->translator->trans('zender_sms.send.button'),
